...
void loop() {
  ...
  if ((millis()-starttime) > sampletime_ms)
  {
    ...
    if(bt_connected > 0){
      ...
      mySerial.println(F(";InsertSensorPackageName;PPD60PV-T2;Particulate Matter;PM;hundreds of particles per cubic foot;hppcf;0;2500;5000;7500;10000"));
      //mySerial.print("\n");
      
      mySerial.print(fah);
      mySerial.println(F(";InsertSensorPackageName;DHT22-F;Temperature;F;degrees Fahrenheit;F;0;25;50;75;100\n"));
      //mySerial.print("\n");
      ...
      mySerial.print(humi);
      mySerial.println(F(";InsertSensorPackageName;DHT22-RH;Humidity;RH;percent;%;0;25;50;75;100\n"));
      //mySerial.print("\n");
    }
